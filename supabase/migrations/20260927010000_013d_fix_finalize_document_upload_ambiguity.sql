-- Migration 013D: fix finalize_document_upload PL/pgSQL status ambiguity.
--
-- PostgreSQL 42702 occurs because RETURNS TABLE exposes status as a PL/pgSQL
-- output variable. The documents UPDATE predicate must use qualified columns.
-- This preserves the RPC contract and all existing behavior.
