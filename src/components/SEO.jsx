...
const SEO = ({ title, description, path = '' }) => {
  ...
  useEffect(() => {
    ...
    // Unified Schema Injection (Organization, SoftwareApplication, and FAQPage using @graph)
    let schemaScript = document.querySelector('#site-schema');
    if (!schemaScript) {
      schemaScript = document.createElement('script');
      schemaScript.id = 'site-schema';
      ...
      schemaScript.text = JSON.stringify({
        ...
        "@graph": [
          ...
          },
          {
            ...
            "description": "Streamline your corporate accounting, multi-agent workflows, and financial operations with an autonomous AI partner.",
            "url": siteUrl,
