  ...
  return (
    <nav className="sticky top-0 z-50 bg-[#090a0f]/80 backdrop-blur-xl border-b border-zinc-800/60">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
        ...
        {/* Brand Logo & Name linked to Home & Smooth Scroll */}
        <Link 
          to="/" 
        ...
        <div className="flex items-center gap-4">
          <button 
            type="button"
            onClick={onOpenDemo}
            className="hidden sm:inline-flex text-sm font-medium text-zinc-300 hover:text-white transition-colors cursor-pointer"
          >
            Book Demo
          </button>
          <Link 
          ...
          <Link 
            to="/auth" 
            className="px-4 py-2 rounded-xl text-sm font-bold text-[#090a0f] bg-emerald-500 hover:bg-emerald-400 shadow-lg shadow-emerald-500/20 hover:shadow-emerald-500/40 hover:-translate-y-0.5 active:translate-y-0 transition-all duration-200"
          >
            Get Started
          </Link>
        </div>
